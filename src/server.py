...
@app.get("/get-user", status_code=200, tags=["Auth"])
def get_user_by_db(username: str):
    """
    Returns the user object from db if the user exists, None otherwise.

    Args:\n
        username: str#      the username of the desired usr
...
def save_user_in_db(request: auth_interfaces.LoginRequest):
    """
    Saves a user object in db with the username and password provided.
